...
@Component({
  selector: 'app-billing1-stripe',
  templateUrl: './billing1-stripe.component.html',
  styleUrls: ['./billing1-stripe.component.css']
})
export class Billing1StripeComponent implements AfterViewInit, OnDestroy {
  ...
  submitOrder() {
    ...
    this.billingService.creatingOrderForStripe(orderToCreate).subscribe((order: Order) => {
