...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20220223101755_AddAdditionalFee2")]
    partial class AddAdditionalFee2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Birthday.RatingForBirthdayPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RatingForBirthdayPackages");
                });
            ...
            modelBuilder.Entity("Core.Entities.BirthdayPackageService", b =>
                {
                    ...
                    b.HasKey("BirthdayPackageId", "ServiceIncludedId");

                    b.HasIndex("ServiceIncludedId");

                    b.ToTable("BirthdayPackageServices");
                });
            ...
            modelBuilder.Entity("Core.Entities.ServiceIncluded", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.BirthdayPackageService", b =>
                {
                    b.HasOne("Core.Entities.BirthdayPackage", "BirthdayPackage")
                        .WithMany("BirthdayPackageServices")
                        .HasForeignKey("BirthdayPackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.ServiceIncluded", "ServiceIncluded")
                        .WithMany("BirthdayPackageServices")
